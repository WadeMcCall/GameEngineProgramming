...
set PATH=%TDM%/bin;%OIS_PATH%/lib;%OGRE_PATH%/build/bin;%BOOST_PATH%/stage/lib;%ZLIB_PATH%/lib;%FREEIMAGE_PATH%;c:/windows;%TINYXML_DIR%/lib;%BASS_PATH%;
mingw32-make BASS_PATH=%BASS_PATH% OIS_PATH=%OIS_PATH% OGRE_PATH=%OGRE_PATH% BOOST_PATH=%BOOST_PATH% GAME_PATH=%GAME_PATH%
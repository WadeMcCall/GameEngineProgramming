...
std::string* BulletSceneNodeMotionState::getSceneNodeID()
{
	return &scene_node_id;
}

BulletSceneNodeMotionState::BulletSceneNodeMotionState(std::string* id, SceneNodeMotion* snm, RenderManager* rm) 
{
	scene_node_id = *id;
   render_manager = rm;
